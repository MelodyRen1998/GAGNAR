...
while (flag) {
  ...
  # h <- seq(0,2,0.4)
  h <- c(2)  # crp and optimal h full & sparse > 3
  alpha <- c(0.05)
  ...
  if(train_start == 1) {
    save(res_topstk, file = "./report/stock_res_supp_full_chain2_a_0025_b_0015.rda")
    break
    }
  ...
  if (train_start == 1) {
    save(gagnar_res, file = "./res/est_res_gagnar_alpha_0_1_sparse_3_train30_test10_a_0_3_b_0_3.rda")
  }
